...
public class StoreMenu implements Command {
    ...
    public void execute() {
        ...
        System.out.println(String.format("Type %s to find purchased order by its id", "\033[0;93m" + FindOrderById.COMMAND + "\033[0m"));
        System.out.println(String.format("Type %s to delete order by its id", "\033[0;93m" + DeleteOrderById.COMMAND + "\033[0m"));
